...
module.exports = async function seedRoute(fastify) {
  ...
  fastify.post('/seed-init', async (request, reply) => {
    ...
    try {
      ...
      const reservations = [
        ['r0000001-0000-0000-0000-000000000001','c0000001-0000-0000-0000-000000000001','b0000001-0000-0000-0000-000000000018',d(-2),d(3),'arrivee',200000],
        ['r0000001-0000-0000-0000-000000000002','c0000001-0000-0000-0000-000000000002','b0000001-0000-0000-0000-000000000012',d(-1),d(2),'arrivee',85000],
        ['r0000001-0000-0000-0000-000000000003','c0000001-0000-0000-0000-000000000003','b0000001-0000-0000-0000-000000000002',d(-3),d(0),'depart_aujourd_hui',45000],
        ['r0000001-0000-0000-0000-000000000004','c0000001-0000-0000-0000-000000000004','b0000001-0000-0000-0000-000000000020',d(1),d(5),'confirmee',200000],
        ['r0000001-0000-0000-0000-000000000005','c0000001-0000-0000-0000-000000000005','b0000001-0000-0000-0000-000000000006',d(0),d(3),'confirmee',65000],
        ['r0000001-0000-0000-0000-000000000006','c0000001-0000-0000-0000-000000000006','b0000001-0000-0000-0000-000000000015',d(2),d(6),'confirmee',120000],
        ['r0000001-0000-0000-0000-000000000007','c0000001-0000-0000-0000-000000000007','b0000001-0000-0000-0000-000000000001',d(3),d(5),'confirmee',45000],
        ['r0000001-0000-0000-0000-000000000008','c0000001-0000-0000-0000-000000000009','b0000001-0000-0000-0000-000000000008',d(4),d(7),'confirmee',65000],
        ['r0000001-0000-0000-0000-000000000009','c0000001-0000-0000-0000-000000000010','b0000001-0000-0000-0000-000000000014',d(1),d(4),'confirmee',120000],
      ]
